...
const pokemonDivInnerHTML=`<div class="image-container">
            ...
            <div class="poke-info">
                ...
                <div class="small">
                    <small class="pike-experience"><i class="fa solid fa-flask"></i>${pokemon.base_experience} exp</small>
                    <small class="pike-experience"><i class="fa solid fa-flask"></i>${pokemon.weight} kg</small>
                </div>
                <div class="poke-type">
